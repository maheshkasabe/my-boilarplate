          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="md:w-1/2">
                <h2 className="text-3xl font-bold mb-6">Thorough Due Diligence</h2>
                <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                  Our Due Diligence agent provides comprehensive analysis to help you make informed decisions about potential business relationships.
                </p>
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400">
                        Identify potential risks and red flags before entering business relationships.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-1">Reputation Analysis</h3>
                      <p className="text-gray-600 dark:text-gray-400">
                        Assess the reputation and track record of potential partners and vendors.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Time saved on due diligence processes
                      </p>
                    </div>
                    <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4">
                      <p className="text-3xl font-bold text-pink-600 dark:text-pink-400 mb-1">80%</p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400">
              Our AI-powered due diligence process delivers insights in three simple steps
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                ...
                <h3 className="text-xl font-semibold mb-3">Input Company Details</h3>
                <p className="text-gray-600 dark:text-gray-400">
                  Enter basic information about the entity you want to analyze, or upload relevant documents.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                ...
                <h3 className="text-xl font-semibold mb-3">AI Data Gathering</h3>
                <p className="text-gray-600 dark:text-gray-400">
                  Our AI searches across multiple databases, public records, news sources, and industry data.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Receive a detailed analysis highlighting risks, compliance issues, and other critical findings.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400">
              Our Due Diligence agent serves a variety of business professionals
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  VC firms, private equity, and investment managers who need to assess potential investments quickly.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">Accelerated investment screening</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-purple-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span className="text-gray-700 dark:text-gray-300">Better risk-adjusted returns</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Teams responsible for evaluating and onboarding suppliers and vendors.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-purple-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">Improved supplier selection</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-purple-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span className="text-gray-700 dark:text-gray-300">Reduced supply chain risk</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  M&A teams and corporate strategists evaluating potential partnerships or acquisitions.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-purple-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">Faster deal evaluation</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-purple-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span className="text-gray-700 dark:text-gray-300">More informed strategic decisions</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Teams responsible for compliance, legal risk, and regulatory oversight.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-purple-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">Enhanced regulatory compliance</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-purple-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span className="text-gray-700 dark:text-gray-300">Improved reputational protection</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto bg-gradient-to-r from-purple-600/10 to-pink-600/10 dark:from-purple-500/20 dark:to-pink-500/20 rounded-2xl p-8 md:p-12">
            <div className="text-center">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
                Schedule a personalized demo to see how our Due Diligence agent can help your organization make better business decisions.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/request-access">
